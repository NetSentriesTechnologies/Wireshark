...
qt_frameworks_dir=$( "/usr/lib/qt5/bin/qmake" -query QT_INSTALL_LIBS )
...
pkgplugin="$bundle/Contents/PlugIns/wireshark/3.3"
...
codesign_file () {
	...
	codesign \
		...
		--force \
		--options runtime \
		--entitlements "/home/fazil-dev-cok/devsec/experiments/wireshark/packaging/macosx/entitlements.plist" \
		--timestamp \
		--verbose \
		"$1"
}
